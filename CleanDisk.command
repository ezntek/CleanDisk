...
then
    ...
    echo 'How much free space is available? (In GB, eg: 100, Means 100GB Free, eg. in disk info it shows 100GB Free (20GB Purgeable), choose the number not in brackets! round down if there is a decimal)'
    read space
    mkdir ~/tmp
